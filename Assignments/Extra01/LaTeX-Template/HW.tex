...
\سربرگ{تمرین امتیازی اول}{}{پاسخ‌دهنده: معین آعلی - 401105561}{استاد: دکتر محمدتقی منظوری}


% \listoflistofproblems


  \مسئله{نشان دهید چرا بیشتر یا مساوی بودن درجه‌ی مخرج از درجه‌ی صورت در یک تابع تبدیل، نشان‌دهنده‌ی علی بودن سیستم است.}
