...
\newline
با توجه به ناحیه همگرایی به دست آمده در بخش قبل ($\frac{1}{2} < |z| < 2$)، دایره واحد ($|z| = 1$) کاملاً درون این ناحیه قرار دارد. بنابراین، این سیگنال {دارای تبدیل فوریه زمان-گسسته است}.
