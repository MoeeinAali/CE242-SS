...
\]
که رابطه‌ی دوم به این دلیل برقرار است که طیف $x(t)$ پایین‌گذر بوده و با مولفه‌ی پربسامد حامل همبستگی ندارد.
...
\]
با گرفتن میانگین زمانی و استفاده از $\seq{x(t)}=0$ و $\seq{x^2(t)}=P_x$ (و حذف جملات پربسامد):
\[
P_{AM} = \seq{x_{AM}^2(t)}
